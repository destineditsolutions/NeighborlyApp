#--------- Flask settings
SERVER_HOST = 'https://myneighborlyfcapp.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://myneighborlyfcapp.azurewebsites.net/api"
